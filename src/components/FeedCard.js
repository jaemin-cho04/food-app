...
export default function FeedCard({ restaurant, onInteract }) {
  ...
  const isHighRated = netLikes > 100;
  const scoreColor = isHighRated ? 'text-orange-600' : 'text-gray-900';
  const badgeColor = isHighRated ? 'bg-orange-50 border-orange-100 text-orange-700' : 'bg-gray-50 border-gray-100 text-gray-600';
